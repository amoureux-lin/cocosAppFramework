...
export class G32SdkDispatcher implements ISingleton {

    protected static _instance: G32SdkDispatcher = null!;
    public static get instance() { return this._instance || (this._instance = new G32SdkDispatcher()); }
    _eventCaches: { [key: string]: Array<IEvent> } = null!;
    constructor() {
        this._eventCaches = {};
    }
    ...
    module: string = null!;
    destory(){
        G32SdkDispatcher._instance = null as any;
    }
    /**
     * @description 添加事件
     * @param type 事件类型
    ...
    public dispatch() {
        ...
        if (!type) return;
        // Array.prototype.shift.apply(arguments);//---默认返回what
        let eventCaches: Array<IEvent> = this._eventCaches[type];
...
window["dispatch"] = function () {
    //向自己封闭的管理器中也分发
    Reflect.apply(G32SdkDispatcher.instance.dispatch,G32SdkDispatcher.instance,arguments);
    G32Log.warn("============= G32SdkDispatcher");
}